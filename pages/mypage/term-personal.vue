<template>
  <div class="mypage-wrap store">
    <div class="tab">
      <div class="tab-list">
        <button type="button" class="tab-list--btn active">
          이용약관
        </button>
        <button type="button" class="tab-list--btn">
          개인정보
        </button>
      </div>
      <div class="tab-con el-scrollbar">
        ...
        >
          ...
          <p>
            이 약관은 하나피아 (이하 '회사' 라고 합니다)가 제공하는 제반
          ...
          <ol>
            ...
            <li>
              ...
              ·문자·음성·음향·이미지 또는 영상 등으로 정보 형태의 글, 사진,
          ...
          <ol>
            <li>
              이 약관은 하나피아(이)가 제공하는 모든 인터넷서비스에 게시하여
          ...
          <ol>
            ...
            <li>
              ...
              경우 '개인정보보호법' 및 같은 법 시행령의 규정에 따라 이용자정보를
              영구적으로&nbsp;삭제할 수 있습니다. 단, 유료결제 상품을 보유하고
              있는 경우 삭제 대상에서 제외되며 관련 법령의 규정에 의하여 보존할
              필요가 있는 경우 회사는 관계 법령에서 정한 기간 동안 이용자정보를
              보관합니다.
            </li>
            <li>
          ...
          <ol>
            ...
            <li>
              ...
              <ol>
                <li>게임제작을 위한 유료 서비스 구매</li>
                <li>게임제작을 위한 유료 에셋 구매</li>
              </ol>
            </li>
          </ol>
          <p>
          ...
          <ol>
            <li>
              ...
              방법으로 이용자에게 제공(또는&nbsp;전송)할 수 있습니다. 다만,
              이용자는 이를 원하지 않을 경우 회사가 제공하는 방법에 따라 수신을
              거부할 수 있습니다.
            </li>
            <li>
          ...
          <p>
            <strong>제19조(유료서비스의 결제 등)</strong>
          </p>
          ...
          <ol>
            <li>
              ...
              <ol>
                ...
                <li>
                  지속적으로 이용가능한 서비스는 이용일수에 해당하는 금액을
                  차감한 나머지 금액을 환불합니다.
                </li>
              </ol>
            </li>
            ...
            <li>
              ...
              진행합니다. 다만, 환불을 위하여 이용자의 협조가 필요한 경우
              이용자의 귀책사유로 환불이 지연된 경우 회사는 지연이자를 부담하지
              않습니다.
            </li>
            <li>환불에 필요한 비용은 귀책사유가 있는 쪽이 부담합니다.</li>
          </ol>
          <p>
            <strong>제21조(권리의 귀속)</strong>
          </p>
          ...
          <p><strong>제24조(관할법원 및 준거법)</strong></p>
          <p>
        ...
        >
          <div class="tui-editor-contents">
            ...
            <p><strong>제1조(목적)</strong></p>
            <p>
              하나피아(이하 ‘회사'라고 함)는 회사가 제공하고자 하는 서비스(이하
            ...
            <ol>
              <li>
                필수 수집 정보:&nbsp;이메일 주소, 비밀번호, 닉네임 및 생년월일
              </li>
            </ol>
            <p><strong>제6조(결제 서비스를 위한 정보)</strong></p>
            <p>
            ...
            <ol>
              <li>필수 수집 정보: &nbsp;생년월일 6자리(yy/mm/dd)</li>
            </ol>
            ...
            <ol>
              ...
              <li>
                선택 수집 정보: &nbsp;(실물상품 지급 시) 이름, 전화번호, 주소 및
                (모바일상품 지급 시) 전화번호
              </li>
            </ol>
            <p>
            ...
            <p>
              ...
              경제상 이익을 불·편법적으로 수취하는 행위, 이용약관 등에서
            ...
            <p><strong>제13조(개인정보의 파기원칙)</strong></p>
            <p>
            ...
            <p>
              <strong>제14조(서비스 미이용자에 대한 개인정보처리)</strong>
            </p>
            ...
            <p><strong>제16조(개인정보파기방법)</strong></p>
            <p>
            ...
            <p><strong>제24조(비밀번호의 암호화)</strong></p>
            <p>
            ...
            <p>
              <strong>제25조(해킹 등에 대비한 대책)</strong>
            </p>
            ...
            <p><strong>제26조(개인정보 처리 최소화 및 교육)</strong></p>
            <p>
              회사는 개인정보 관련 처리 담당자를 최소한으로 제한하며, 개인정보
              처리자에 대한 교육 등 관리적 조치를 통해 법령 및 내부방침 등의
              준수를 강조하고 있습니다.
            </p>
            <p><strong>제27조(개인정보 유출 등에 대한 조치)</strong></p>
            <p>
            ...
            <p>
              <strong>제28조(개인정보 유출 등에 대한 조치의 예외)</strong>
            </p>
            <p>
            ...
            <p>
              <strong>제29조(이용자의 쿠키 설치 선택권)</strong>
            </p>
            ...
            <p><strong>제30조(쿠키 설치 허용 지정 방법)</strong></p>
            <p>
            ...
            <ol>
              ...
              <li>[고급] 설정에서 설정하시면 됩니다.</li>
            </ol>
            <p>
              <strong>제31조(회사의 개인정보 보호 책임자 지정)</strong>
            </p>
                  ...
                  <li>
                    ...
                    <ol>
                      ...
                      <li>
                        이메일:
                        <a
                          href="mailto:projectkoo.koo.2023@gmail.com"
                          target="_blank"
                          >projectkoo.koo.2023@gmail.com</a
                        >
                      </li>
                    </ol>
                  </li>
