        ...
        <div class="upload-spot">
          <label class="input-file">
            <input
              ...
              name="myAssetsFile"
              required
              :accept="assetsType === 'S' ? 'sound/mp3' : 'image/png'"
        ...
        <div class="upload-set">
          ...
          <el-scrollbar class="scroll">
            <p>
              ...
              침해하는 게시물을 홈페이지에 게재 또는 등록하여서는 아니됩니다.<br />
              ...
              경우에는 반드시 해당회원의 명시적 동의를 얻은 뒤 사용하여야
              합니다. <br />
              회원이 서비스 이용과정에서 타인의 저작권, 상표권, 의장권 등
              지적재산권을 침해하는 경우 당사는 어떠한 책임도 부담하지 않습니다.
            </p>
            <p>
              당사의 플랫폼은 모든 사용자에게 안전하고 존중받는 환경을 제공하기
              위해 최선을 다하고 있습니다. 이에 따라 사용자를 위한 가이드를
              제공하며, 내용은 다음과 같습니다.<br />
              1. 과도한 노출 및 성적인 콘텐츠 정책 <br />
              노골적이거나 외설적이거나 불쾌감을 주는 모든 형태의 과도한
              노출이나 성적인 콘텐츠의 공유를 엄격히 금지합니다. 여기에는 다음을
              묘사하거나 장려하는 콘텐츠가 포함되며 이에 국한되지 않습니다.<br />
              · 성기, 엉덩이, 가슴(여성 또는 남성)을 포함한 전체 또는 부분 누드
              <br />
              · 성행위 또는 성행위 시뮬레이션 <br />
              · 노골적인 성적 언어 또는 대화 <br />
              · 성희롱 또는 학대 <br />
              ...
              · 성적 만족을 위한 과도한 노출 또는 부분적인 노출 · 수간 또는 수간
              조장 <br />
              · 근친상간 또는 근친상간 조장 <br />
            ...
            <p>
              ...
              엄격히 금지합니다. 여기에는 다음을 묘사하거나 장려하는 콘텐츠가
              포함되며 이에 국한되지 않습니다. <br />
              ...
              · 사람을 죽이거나 해치는 방법<br />
              · 중독성 마약 흡입 또는 제조<br />
              · 거식증이나 기타 섭식 장애를 칭송하거나, 미화하거나, 따라하도록
              독려<br />
              ...
              · 일반적으로 요금 결제가 필요한 오디오 콘텐츠, 시청각 콘텐츠, 정식
              버전의 비디오 게임, 소프트웨어
            </p>
            <p>
              3. 아동 학대 콘텐츠 정책<br />
              당사 플랫폼은 아동 학대를 조장, 미화 또는 선동하는 콘텐츠의 게시
              또는 공유를 엄격히 금지합니다. 여기에는 다음을 묘사하거나 장려하는
              콘텐츠가 포함되며 이에 국한되지 않습니다. <br />
              · 미성년자가 나오는 음란물 및 미성년자를 성적으로 착취하는
              콘텐츠<br />
              · 미성년자와 가족을 대상으로 하지만 성적인 주제나 폭력을 포함하고
              있는 콘텐츠<br />
              · 미성년자가 위험한 행동에 가담하는 모습을 보여주거나 미성년자에게
              위험한 행동을 독려하는 콘텐츠<br />
            ...
            <p>
              4. 자살 및 자해에 대한 콘텐츠 정책 당사 플랫폼은 정신건강에 대한
              인식과 이해의 중요성을 잘 알고 있습니다. 이 때문에 크리에이터들이
              우울증, 자해 또는 기타 정신건강 문제에 대한 경험을 다룬 콘텐츠를
              게시하는 등 자신의 이야기를 공유하도록 지원하고 있습니다.<br />
              하지만 자살과 자해를 조장하거나 충격 또는 혐오감을 불러일으키려는
              목적으로 제작되었거나 시청자에게 상당한 위험을 초래할 수 있는
              콘텐츠는 허용되지 않습니다. 여기에는 다음을 묘사하거나 장려하는
              콘텐츠가 포함되며 이에 국한되지 않습니다.
              <br />
              · 자살 또는 자해를 조장하거나 미화하는 콘텐츠 <br />
              · 자살 또는 자해 방법에 대한 안내 <br />
              · 미성년자를 대상으로 한 자살 또는 자해 관련 콘텐츠 <br />
              · 노골적인 자해 이미지 <br />
              · 완전히 알아볼 수 없도록 자살 희생자를 흐리게 처리하거나 가리지
              않은 이미지 <br />
              · 자살 방법을 알려주는 자세한 정보나 함께 사용된 흐리게 처리된
              이미지 또는 그 밖의 콘텐츠<br />
              · 자살에 이르는 과정 또는 자살 시도를 맥락없이 묘사하는 콘텐츠<br />
              · 자살 및 자해 도전에 참여하거나 그 방법을 안내하는 콘텐츠
              <br />
              · 충분한 맥락이 없는 유서<br />
              · 자살 또는 자해 방법 및 위치, 대표적인 자살 장소에 대한 자세한
              설명 <br />
              · 자해 또는 자살에 대한 노골적인 묘사<br />
            </p>
            <p>
              다음 기준 중 하나 이상을 충족하는 경우 상기 콘텐츠를 삭제하는 대신
              제한을 적용하는 경우도 있습니다. <br />
              ...
              적용 범위는 범위는 텍스트, 이미지, 동영상, 오디오 모두 포함되며
              당사는 단독 재량에 따라 부적절하다고 판단되는 사용자의 제작물을
              사전 통보 없이 삭제처리 할 수 있음을 알려드립니다.<br />
              이 정책에 대해 질문이나 우려 사항이 있는 경우 당사에 문의하십시오.
            </p>
          </el-scrollbar>
...
export default {
  ...
  methods: {
    ...
    onChangeUploadPreview(e) {
      ...
      if (this.ext !== 'mp3' && this.assetsType === 'S') {
        e.target.files = null
        return alert('mp3 확장자만 업로드가 가능합니다')
      }
      if (this.ext !== 'png' && this.assetsType !== 'S') {
        e.target.files = null
